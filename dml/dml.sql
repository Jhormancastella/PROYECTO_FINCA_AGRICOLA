...
VALUES
    ...
    (2, 1, '2023-09-02', 30.00, 2.50),   
    (3, 2, '2023-09-03', 20.00, 2.75),
    (4, 2, '2023-09-04', 15.00, 3.00),
    (5, 3, '2023-09-05', 10.00, 3.50),
    (6, 3, '2023-09-06', 5.00, 2.90),
    (7, 4, '2023-09-07', 25.00, 2.45),
    (8, 4, '2023-09-08', 18.00, 2.60),
    (9, 5, '2023-09-09', 12.00, 3.70),
    (10, 5, '2023-09-10', 8.00, 2.10),
    (1, 6, '2023-09-11', 40.00, 3.20),
    (2, 6, '2023-09-12', 55.00, 1.80),
    (3, 7, '2023-09-13', 22.00, 3.00),
    (4, 7, '2023-09-14', 26.00, 3.25),
    (5, 8, '2023-09-15', 29.00, 2.85),
    (6, 8, '2023-09-16', 16.00, 2.30),
    (7, 9, '2023-09-17', 24.00, 2.75),
    (8, 9, '2023-09-18', 14.00, 3.05),
    (9, 10, '2023-09-19', 9.00, 1.95),
    (10, 10, '2023-09-20', 4.00, 2.50),
    (1, 1, '2023-09-21', 60.00, 2.40),
    (2, 1, '2023-09-22', 35.00, 2.60),
    (3, 2, '2023-09-23', 21.00, 2.90),
    (4, 2, '2023-09-24', 16.00, 3.15),
    (5, 3, '2023-09-25', 11.00, 3.45),
    (6, 3, '2023-09-26', 6.00, 2.75),
    (7, 4, '2023-09-27', 25.00, 2.70),
    (8, 4, '2023-09-28', 19.00, 2.95),
    (9, 5, '2023-09-29', 13.00, 3.85),
    (10, 5, '2023-09-30', 10.00, 2.20),
    (1, 6, '2023-10-01', 41.00, 3.15),
    (2, 6, '2023-10-02', 56.00, 1.85),
    (3, 7, '2023-10-03', 23.00, 3.05),
    (4, 7, '2023-10-04', 27.00, 3.30),
    (5, 8, '2023-10-05', 30.00, 2.95),
    (6, 8, '2023-10-06', 17.00, 2.40),
    (7, 9, '2023-10-07', 27.00, 2.85),
    (8, 9, '2023-10-08', 15.00, 3.10),
    (9, 10, '2023-10-09', 10.00, 2.00),
    (10, 10, '2023-10-10', 5.00, 2.60),
    (1, 1, '2023-10-11', 62.00, 2.35),
    (2, 1, '2023-10-12', 37.00, 2.55),
    (3, 2, '2023-10-13', 19.00, 2.85),
    (4, 2, '2023-10-14', 12.00, 3.10),
    (5, 3, '2023-10-15', 14.00, 3.35),
    (6, 3, '2023-10-16', 9.00, 2.65),
    (7, 4, '2023-10-17', 23.00, 2.80),
    (8, 4, '2023-10-18', 21.00, 3.00),
    (9, 5, '2023-10-19', 18.00, 3.90),
    (10, 5, '2023-10-20', 8.00, 2.30);
...
VALUES
    ...
    (1, 4, 70.00, '2023-08-20', 'Uso de pesticida biológico en hortalizas'),
    (2, 5, 30.00, '2023-08-22', 'Uso de semillas de café arábiga'),
    (3, 6, 90.00, '2023-08-25', 'Uso de fungicida orgánico en cultivos'),
    (1, 7, 120.00, '2023-09-01', 'Aplicación de fertilizante líquido para riego'),
    (2, 8, 80.00, '2023-09-03', 'Uso de semillas de cacao fino'),
    (3, 9, 50.00, '2023-09-05', 'Uso de microorganismos benéficos en el suelo'),
    (1, 10, 60.00, '2023-09-08', 'Uso de repelente natural de insectos'),
    (2, 11, 150.00, '2023-09-10', 'Uso de sal mineral agrícola en hortalizas'),
    (3, 12, 40.00, '2023-09-12', 'Aplicación de bioestimulante vegetal en cultivos'),
    (1, 13, 70.00, '2023-09-15', 'Uso de semillas de aguacate'),
    (2, 14, 90.00, '2023-09-17', 'Uso de regulador de pH para suelo'),
    (3, 15, 60.00, '2023-09-20', 'Uso de micorrizas en el cultivo de raíces'),
    (1, 16, 100.00, '2023-09-22', 'Uso de aceite agrícola mineral para maquinaria'),
    (2, 17, 50.00, '2023-09-25', 'Uso de semillas de tomate injertado'),
    (3, 18, 80.00, '2023-09-26', 'Uso de polímero retenedor de humedad en el suelo'),
    (1, 19, 40.00, '2023-09-28', 'Uso de extracto de neem para plagas'),
    (2, 20, 35.00, '2023-09-29', 'Uso de semillas de pimiento'),
    (3, 21, 25.00, '2023-10-01', 'Uso de calcio foliar en cultivos vegetales'),
    (1, 22, 70.00, '2023-10-03', 'Uso de trampa cromática para insectos'),
    (2, 23, 50.00, '2023-10-04', 'Uso de semillas de chiles'),
    (3, 24, 30.00, '2023-10-05', 'Uso de aminoácidos vegetales en cultivos'),
    (1, 25, 45.00, '2023-10-06', 'Uso de kit de pH y nutrientes en análisis de suelo'),
    (2, 26, 20.00, '2023-10-07', 'Uso de semillas de plátano'),
    (3, 27, 60.00, '2023-10-08', 'Uso de arcilla agrícola para mejorar la estructura del suelo'),
    (1, 28, 75.00, '2023-10-09', 'Uso de bacterias promotoras de crecimiento'),
    (2, 29, 50.00, '2023-10-10', 'Uso de semillas de cítricos'),
    (3, 30, 100.00, '2023-10-11', 'Aplicación de quelatos de hierro para suelos'),
    (1, 31, 90.00, '2023-10-12', 'Uso de abono verde en cultivos'),
    (2, 32, 25.00, '2023-10-13', 'Uso de semillas de árboles nativos'),
    (3, 33, 150.00, '2023-10-14', 'Uso de silicio líquido en fortalecimiento de plantas'),
    (1, 34, 100.00, '2023-10-15', 'Uso de adherente natural para mejorar aplicación de productos'),
    (2, 35, 70.00, '2023-10-16', 'Uso de semillas de café robusta'),
    (3, 36, 60.00, '2023-10-17', 'Uso de azufre agrícola para corregir suelos alcalinos'),
    (1, 37, 220.00, '2023-10-18', 'Uso de probióticos vegetales en cultivos'),
    (2, 38, 95.00, '2023-10-19', 'Uso de semillas de hortalizas de altura'),
    (3, 39, 30.00, '2023-10-20', 'Uso de ácidos húmicos en activación del suelo'),
    (1, 40, 55.00, '2023-10-21', 'Uso de biofertilizante foliar en cultivaciones'),
    (2, 41, 75.00, '2023-10-22', 'Uso de semillas de cultivos alternativos'),
    (3, 42, 65.00, '2023-10-23', 'Uso de zeolita agrícola para retener nutrientes'),
    (1, 43, 45.00, '2023-10-24', 'Uso de extracto de algas para bioestimulación'),
    (2, 44, 35.00, '2023-10-25', 'Uso de semillas de flores comestibles'),
    (3, 45, 100.00, '2023-10-26', 'Uso de magnesio agrícola para corregir deficiencias nutricionales'),
    (1, 46, 75.00, '2023-10-27', 'Uso de biocarbón para mejorar la calidad del suelo');
...
VALUES
    ...
    (2, 3, '2023-08-15', 4.5, 'Reparación de maquinaria'),
    (2, 4, '2023-08-16', 6.0, 'Cosecha de hortalizas'),
    (3, 5, '2023-08-17', 2.0, 'Preparación de suelo'),
    (4, 6, '2023-08-18', 1.5, 'Aplicación de fertilizante'),
    (5, 7, '2023-08-19', 4.0, 'Compactación del terreno'),
    (6, 8, '2023-08-20', 3.0, 'Revisión de maquinaria'),
    (7, 9, '2023-08-21', 5.5, 'Cosecha de maíz'),
    (8, 10, '2023-08-22', 4.0, 'Desmalezado'),
    (9, 11, '2023-08-23', 2.5, 'Incorporación de insumos'),
    (10, 12, '2023-08-24', 3.5, 'Segmentación de terreno'),
    (11, 13, '2023-08-25', 4.0, 'Mantenimiento de sistemas'),
    (12, 14, '2023-08-26', 6.0, 'Uso en obra de construcción'),
    (13, 15, '2023-08-27', 1.0, 'Mantenimiento menor'),
    (14, 16, '2023-08-28', 5.0, 'Fumigación de cultivos'),
    (15, 17, '2023-08-29', 4.0, 'Acondicionamiento de terreno'),
    (16, 18, '2023-08-30', 2.5, 'Uso en producción de frutas'),
    (17, 19, '2023-09-01', 5.0, 'Cosecha de verduras'),
    (18, 20, '2023-09-02', 3.0, 'Distribución de fertilizante'),
    (19, 21, '2023-09-03', 4.0, 'Revisión de maquinarias'),
    (20, 22, '2023-09-04', 2.5, 'Uso durante lluvias'),
    (21, 23, '2023-09-05', 7.0, 'Descompactación de terreno'),
    (22, 1, '2023-09-06', 4.5, 'Empacado de heno'),
    (23, 2, '2023-09-07', 1.5, 'Revisión general'),
    (1, 3, '2023-09-08', 5.0, 'Fumigación y control de plagas'),
    (2, 4, '2023-09-09', 6.5, 'Trabajo de construcción'),
    (3, 5, '2023-09-10', 3.0, 'Revisión de seguridad'),
    (4, 6, '2023-09-11', 8.0, 'Arado de campo'),
    (5, 7, '2023-09-12', 4.5, 'Segmentación de cultivos'),
    (6, 8, '2023-09-13', 2.0, 'Uso para labores pesadas'),
    (7, 9, '2023-09-14', 5.5, 'Segado de pasto'),
    (8, 10, '2023-09-15', 3.5, 'Acondicionamiento de cultivo'),
    (9, 11, '2023-09-16', 4.0, 'Revisión de movilidad'),
    (10, 12, '2023-09-17', 6.0, 'Cosecha de frutas'),
    (11, 13, '2023-09-18', 5.0, 'Corte de árboles'),
    (12, 14, '2023-09-19', 4.0, 'Transporte de materiales'),
    (13, 15, '2023-09-20', 2.5, 'Uso en trabajos menores'),
    (14, 16, '2023-09-21', 3.0, 'Control de plagas'),
    (15, 17, '2023-09-22', 4.5, 'Fumigación de cultivos'),
    (16, 18, '2023-09-23', 2.0, 'Inspección de seguridad'),
    (17, 19, '2023-09-24', 5.0, 'Siembra de semillas'),
    (18, 20, '2023-09-25', 3.5, 'Manejo de cultivos'),
    (19, 21, '2023-09-26', 4.5, 'Revisión general del sistema'),
    (20, 22, '2023-09-27', 2.0, 'Acondicionamiento de terreno'),
    (21, 23, '2023-09-28', 5.0, 'Uso en actividades programadas'),
    (22, 1, '2023-09-29', 3.0, 'Inspección general.'),
    (23, 2, '2023-09-30', 4.5, 'Revisión del sistema eléctrico');
